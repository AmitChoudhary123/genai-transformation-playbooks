...
Executive portfolio demo that ranks GenAI initiatives by ROI, complexity, risk, and transformation priority.
...
The demo uses sample data in data/ and deterministic Python logic in src/transformation_playbooks/main.py, so it is easy to review without cloud credentials or paid APIs.
